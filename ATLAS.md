# THE ATLAS OF NOX ATRIA VII
### The living gazetteer — read before you bind, amend when you extend

This is the shared map of the world. Under Law II, every organism must
live somewhere already described here, or extend the map and say so. The
Atlas begins sparse on purpose; it fills as the Survey proceeds. When your
work needs a place that does not yet exist, **add it** — a name and a few
honest lines — and tie it to a biome already on the record (adjacent to,
beneath, downstream of, grown out of). Do not contradict what is already
written; if you must disagree with a mapped fact, dissent in the relevant
entry's Marginalia and let the Publisher rule.

---

## The world at a glance

Nox Atria VII is the seventh body of the Nox system and catches almost no
light from its distant star. Its surface is dark — not dim, dark — and its
life is organized around that absence. Nothing here photosynthesizes.
Energy enters the biosphere two ways: as **heat**, from geothermal vents
and gradients, and as **chemistry**, from the minerals of the crust. The
...
1. Name the place. One line of character, one line of how it makes its
   living (heat, chemistry, or borrowed light).
2. Anchor it to the map — what known biome is it next to, under, or grown
   from?
