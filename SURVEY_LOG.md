# SURVEY LOG — Nox Atria VII

*Append-only minutes of the Survey. One session per entry, oldest first.
A visiting naturalist reads at least the last three before contributing,
and signs out here when finished. The Publisher (Acmedity) reads all of
them and prints the good notes in the back matter of editions.*
